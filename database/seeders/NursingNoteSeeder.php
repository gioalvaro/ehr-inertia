...
class NursingNoteSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('nursing_notes')->insert([
            'id' => 1,
            'created_at' => new Carbon(new DateTime('2017-08-10 8:10')),
            'encounter_id' => 3,
            'nursing_type_id' => 4,
        ...
        DB::table('nursing_notes')->insert([
            'id' => 2,
            'created_at' => new Carbon(new DateTime('2017-08-10 8:45')),
            'encounter_id' => 4,
            'nursing_type_id' => 1,
        ...
        DB::table('nursing_notes')->insert([
            'id' => 3,
            'created_at' => new Carbon(new DateTime('2017-08-10 9:45')),
            'encounter_id' => 5,
            'nursing_type_id' => 1,
        ...
        DB::table('nursing_notes')->insert([
            'id' => 4,
            'created_at' => new Carbon(new DateTime('2018-02-09 10:30')),
            'encounter_id' => 6,
            'nursing_type_id' => 1,
        ...
        DB::table('nursing_notes')->insert([
            'id' => 5,
            'created_at' => new Carbon(new DateTime('2018-06-13 09:35')),
            'encounter_id' => 7,
            'nursing_type_id' => 1,
        ...
        DB::table('nursing_notes')->insert([
            'id' => 6,
            'created_at' => new Carbon(new DateTime('2018-10-16 10:15')),
            'encounter_id' => 8,
            'nursing_type_id' => 1,
